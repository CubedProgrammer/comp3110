...
func spawn_harvestable_tree(position: Vector2, island: Island, tilemap_location: Vector2):
	...
	harvestable_tree.sapling = island.tile_states[Vector2i(tilemap_location)].plant_on_tile
	harvestable_tree.belonging_island = island
	harvestable_tree.tile = tilemap_location
