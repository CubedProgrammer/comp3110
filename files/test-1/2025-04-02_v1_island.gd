...
func update_game_tile(tile_position: Vector2i):
	...
	var current_state = tile_data.state         
	print(current_state)
	match current_state:
		0:
			print("at 0")
		1:
			print("at 1")
		2:
			print('Changing to dirt at position: ', tile_position)
			addonTileMap.set_cell(tile_position, 2, Vector2i(10, 1))
		_: 
			print("at default")
